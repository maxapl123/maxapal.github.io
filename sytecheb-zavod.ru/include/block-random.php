...
if  (strlen($res_query["image"]) > 0 && file_exists("".$_SERVER['DOCUMENT_ROOT']."/uploads_images/".$res_query["image"]))
{
$img_path = 'http://demo.shop-training.ru/uploads_images/'.$res_query["image"];
$max_width = 120; 
$max_height = 120; 
